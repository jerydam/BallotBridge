...
const s3 = new AWS.S3({
    accessKeyId: 'EA25B2F44D45FD5FD6F4', 
    secretAccessKey: '0Bs6JtKH21nL04OsuAi1fzhenoYJgVukClZLbvxk', 
...
fs.readFile(filePath, (err, data) => {
    ...
    const params = {
        Bucket: 'xpresscollection', 
        Key: `ballotbridge/${fileName}`, // Corrected the Key to use the file name only
